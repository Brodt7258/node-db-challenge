...
The former is a general style of database.  The latter is the language used interact with that style

- [ ] Why do tables need a `primary key`?
to ensure that every record can always be uniquely identified

- [ ] What is the name given to a table column that references the primary key on another table.
a foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
a third table that describes the relationships between the two tables
